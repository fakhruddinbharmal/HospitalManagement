...
namespace Hospital.Controls
{
    public partial class PatientListControl : ObjectListControl
    {
        ...
        private void LoadListData(Patient selected)
        {
            ...
            this.LoadEntityList<Patient>(this.dgvData, this.clmNumber.Index, new Patients(tstSearch.Text, true, false, cmbPatientStatus.SelectedIndex, fromDate, toDate), selected,
                delegate(DataGridViewRow row, Patient obj)
                {
                    ...
                    row.Cells[this.clmMaritalStatus.Index].Value = obj.PatientMaritalStatus;
                    row.Cells[this.clmMarkOfIdentity.Index].Value = obj.PatientMarkOfIdentity;
                    ...
                    row.Cells[this.clmRelatedPoliceStation.Index].Value = obj.RelatedPoliceStation;

                    row.Cells[this.clmPatientIndoorNo.Index].Value = obj.PatientIndoorNo;
                }
            );
