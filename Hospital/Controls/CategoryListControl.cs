...
{
    public partial class CategoryListControl : Hospital.Controls.ObjectListControl
    {
        public CategoryListControl() : base()
        {
            InitializeComponent();
        ...
        private void LoadListData(Category selected)
        {
            int count = 0;
            this.LoadEntityList<Category>(this.dgvData, this.clmCategory.Index, new CategoryCollection(tstSearch.Text), selected,
                delegate(DataGridViewRow row, Category obj)
                {
                    count++;
        ...
        {
            return GetSelectedEntity(this.dgvData) as Category;
        }
        ...
        private Category GetSelectedEntityObject()
        {
            return GetSelectedEntity(this.dgvData) as Category;
        }
