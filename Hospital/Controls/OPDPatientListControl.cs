...
namespace Hospital.Controls
{
    public partial class OPDPatientListControl : ObjectListControl
    {
        ...
        private void LoadListData(Patient selected)
        {
            ...
            this.LoadEntityList<Patient>(this.dgvData, this.clmNumber.Index, new Patients(tstSearch.Text, false, true, cmbPatientStatus.SelectedIndex, fromDate, toDate), selected,
                delegate(DataGridViewRow row, Patient obj)
                {
                    ...
                    row.Cells[this.clmNote.Index].Value = obj.Notes;
                }
            );
