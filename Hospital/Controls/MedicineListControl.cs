...
{
    public partial class MedicineListControl : Hospital.Controls.ObjectListControl
    {
        ...
        {
            int count = 0;
            this.LoadEntityList<Medicine>(this.dgvData, this.clmMedicine.Index, new MedicineCollection(tstSearch.Text), selected,
